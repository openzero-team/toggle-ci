...
var ciRegex = /^(.* CI|Jenkins|Zuul|openzeroci|jenkins-ci)$/;
...
var trustedCIRegex = /^(OpenStack CI|Jenkins|Zuul|openzeroci|jenkins-ci)$/;
// this regex matches the name+pipeline that we want at the top of the CI list
var firstPartyCI = /^(Jenkins|Zuul|openzeroci|jenkins-ci)/;
...
window.onload = function() {
    if (!document.getElementById("toggleci")) {
